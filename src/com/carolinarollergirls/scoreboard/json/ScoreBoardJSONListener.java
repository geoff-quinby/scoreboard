...
public class ScoreBoardJSONListener implements ScoreBoardListener {
    ...
    private void processCurrentRuleset(String path, Rulesets r) {
        ...
        updates.add(new WSUpdate(path + "." + Rulesets.EVENT_CURRENT_RULESET + ".Id", r.getCurrentRuleset().getId()));
        updates.add(new WSUpdate(path + "." + Rulesets.EVENT_CURRENT_RULESET + ".Name", r.getCurrentRuleset().getName()));
    }
