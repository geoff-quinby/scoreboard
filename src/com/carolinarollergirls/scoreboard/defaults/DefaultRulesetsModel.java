...
public class DefaultRulesetsModel extends DefaultScoreBoardEventProvider implements RulesetsModel {
    ...
    private void initialize() {
        ...
        Map<String, String> rootSettings = new Hashtable<String, String>();
    ...
    private void setCurrentRulesetRecurse(String id) {
        ...
        if (!rs.getId().equals(rootId)) {
          setCurrentRuleset(rs.getParentRulesetId());
        }
    ...
    public Map<String, Ruleset> getRulesets() {
        synchronized (coreLock) {
            return Collections.unmodifiableMap(new Hashtable<String, Ruleset>(rulesets));
        }
    }
    ...
    public RulesetModel addRuleset(String name, String parentId, String id) {
        synchronized (coreLock) {
            ...
            scoreBoardChange(new ScoreBoardEvent(r, EVENT_RULESET, r, ""));
            return r;
        }
    }
    ...
    private Map<String, String> current = new Hashtable<String, String>();
    private Map<String, RulesetModel> rulesets = new Hashtable<String, RulesetModel>();
    private Ruleset currentRuleset = null;
    private Map<String, Rule> rules = new Hashtable<String, Rule>();
    ...
    public static class DefaultRulesetModel extends DefaultScoreBoardEventProvider implements RulesetModel {
        ...
        public void setName(String n) {
            synchronized (coreLock) {
                ...
                name = n;
                scoreBoardChange(new ScoreBoardEvent(this, EVENT_RULESET, this, ""));
            }
        }
